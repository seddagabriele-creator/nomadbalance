...
export default function FastingGuide() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <SEO title="Intermittent Fasting Guide for Professionals" description="A practical guide to intermittent fasting for busy professionals. Learn how strategic meal timing can boost your energy and focus throughout the workday." />
