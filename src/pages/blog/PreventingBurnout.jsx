...
export default function PreventingBurnout() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <SEO title="Preventing Burnout as a Remote Worker: Early Signs and Practical Solutions" description="How to recognize burnout before it hits and build sustainable work habits that protect your mental health." />
