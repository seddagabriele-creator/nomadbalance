...
export default function MicroExercises() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <SEO title="Micro-Exercises: 2-Minute Movements That Prevent Desk Pain" description="Quick targeted exercises you can do between meetings without changing clothes or breaking a sweat." />
