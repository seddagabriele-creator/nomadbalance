...
export default function BackPainSittingAllDay() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <SEO title="Back Pain From Sitting All Day? A Remote Worker's Recovery Guide" description="Understanding why desk work destroys your back and a complete plan to fix and prevent the damage." />
