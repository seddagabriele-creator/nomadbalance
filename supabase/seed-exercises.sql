...
(
  ...
  'Stand with back, head, and arms against wall. Arms in goalpost position (elbows at 90°). Slowly slide arms up overhead keeping wall contact. Slide back down. If you can''t keep full contact, step your feet away from the wall, bring your arms only as close as you can, and slide up as far as possible. You should feel a stretch. The key is to never let your back leave the wall.',
